...
| 2026-09-26 | 0.10.0 | — / 8/8 | — / $1.93 | regression check after the Opus 5.5 changes (code stays on Opus, leaner advice): same cost as 0.9, still about 12% below Claude alone on high ($2.20, 0.6.0 run) |
